...
using daytot.bll.repositories;
using daytot.core.contracts;


namespace daytot.bll.helpers
{
    /// <summary>
            ...
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   ...
                   {typeof(IAskRepository), dbContext => new AskRepository(dbContext)},
                   {typeof(IReplyRepository), dbContext => new ReplyRepository(dbContext)},
                   {typeof(IMediaRepository), dbContext => new MediaRepository(dbContext)},
                   {typeof(IMediaServerRepository), dbContext => new MediaServerRepository(dbContext)},
                   ...
                   {typeof(ILectureRepository), dbContext => new LectureRepository(dbContext)},
                   ...
                   {typeof(IHintRepository), dbContext => new HintRepository(dbContext)},
                   {typeof(IAnswerRepository), dbContext => new AnswerRepository(dbContext)},
                   {typeof(IQuizRepository), dbContext => new QuizRepository(dbContext)},
                   {typeof(IQuizDetailRepository), dbContext => new QuizDetailRepository(dbContext)},

                   {typeof(IFavoriteRepository), dbContext => new FavoriteRepository(dbContext)},
                   {typeof(IEnrollmentRepository), dbContext => new EnrollmentRepository(dbContext)},
                   {typeof(ILearnActivityRepository), dbContext => new LearnActivityRepository(dbContext)},
                   {typeof(IQuizActivityRepository), dbContext => new QuizActivityRepository(dbContext)}
